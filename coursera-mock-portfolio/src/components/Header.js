...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      curScrollCoords > prevScrollCoordsRef.current
  ...
  return (
    ...
    <Box
      ...
      ref={headerRef}
    >
      <Box color="white" maxWidth="1280px" margin="0 auto" ref={headerRef}>
        <HStack px={16} py={4} justifyContent="space-between" alignItems="center">
          <nav>
            <HStack spacing={6}>
              {socials.map((social, index) => (
                <a key={index} href={social.url} className="headerlink">
